    ...
    <StoreInventorySearchProvider>
      <PageScaffold>
        ...
        <section className="relative">
          ...
          <div className="relative mx-auto min-w-0 max-w-brand px-4 pb-8 sm:px-6">
            <div className="-mt-14 flex flex-col items-center sm:-mt-16">
              <div className="flex h-24 w-24 items-center justify-center rounded-2xl border-4 border-white bg-slate-900 text-2xl font-bold text-white shadow-lg sm:h-28 sm:w-28">
                {store.logo}
              </div>
              ...
              <p className="mt-2 max-w-xl text-center text-sm text-muted-foreground sm:text-base">{store.description}</p>

              <div className="mt-3 flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-sm font-semibold text-foreground">
              ...
              <div className="mt-6 flex w-full max-w-md flex-col gap-3 sm:max-w-none sm:flex-row sm:flex-wrap sm:justify-center">
                <a
        ...
        <div className="mx-auto min-w-0 max-w-brand px-3 pb-16 sm:px-6">
          ...
          <section className="mt-14 rounded-2xl border border-border bg-card p-6 text-card-foreground shadow-sm md:grid md:grid-cols-[220px_1fr] md:gap-8">
